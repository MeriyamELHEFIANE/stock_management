...
SECRET_KEY = 'django-insecure--edffuw-9jtgcpi%1=i6@nhhb^ktcrax@%l-nk+jobkc8s!iio'
...
CORS_ALLOW_ALL_ORIGINS = True  # Dev local
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # pour servir ton frontend CSS/JS
]
